...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from 'maki-sdk'
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      case 'MakiswapRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'MakiswapRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =

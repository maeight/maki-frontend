...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from 'makiswap-uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy MAKI and HT tokens')}</li>
            <li>{TranslateString(598, 'Get MAKI-HT LP tokens by adding MAKI and HT liquidity')}</li>
          </List>
          <Flex mb="16px">
          ...
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your MAKI-LP tokens to buy the IFO tokens')}</li>
          </List>
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with MakiSwap, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on HECO.',
              )}
            </Text>
            <Button
              as="a"

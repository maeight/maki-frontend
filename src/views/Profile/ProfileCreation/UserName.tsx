...
const UserName: React.FC = () => {
  ...
  const hasMinimumCakeRequired = useHasMakiBalance(minimumCakeToRegister)
    ...
    <>
      ...
      {!hasMinimumCakeRequired && (
        <Text color="failure" mt="16px">
          {TranslateString(1098, `A minimum of ${REGISTER_COST} MAKI is required`, { num: REGISTER_COST })}
        </Text>
      )}
    </>
  )

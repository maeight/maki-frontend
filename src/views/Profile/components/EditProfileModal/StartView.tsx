...
import { Button, Flex, Text, InjectedModalProps } from 'makiswap-uikit'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  const hasMinimumCakeRequired = useHasMakiBalance(profile.isActive ? numberCakeToUpdate : numberCakeToReactivate)
  ...
  /**
   * Check if the wallet has the required MAKI allowance to change their profile pic or reactivate
      ...
      <Flex alignItems="center" style={{ height: '48px' }} justifyContent="center">
        <Text as="p" color="failure">
          {!hasMinimumCakeRequired &&
            TranslateString(999, `${getFullDisplayBalance(numberCakeToUpdate)} MAKI required to change profile pic`)}
        </Text>
      </Flex>
      {profile.isActive ? (
        <>

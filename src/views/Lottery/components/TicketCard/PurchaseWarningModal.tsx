  ...
  return (
    <Modal title={t('Warning')} onDismiss={onDismiss}>
      <TicketsList>
        ...
        <br />
        {t('Your MAKI will not be returned to you after you spend it to buy tickets.')}
        <br />
        {t('Tickets are only valid for one lottery draw, and will be burned after the draw.')}
        <br />
        {t('Buying tickets does not guarantee you will win anything. Please only participate once you understand the risks.',)}
      </TicketsList>
      <ModalActions>
